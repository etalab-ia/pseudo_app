...
Estimer la quantité de données à annoter est un premier pas lors du lancement d'une campagne d'annotation.
...
"""),
    ...
    Cet exemple a été choisi afin de faciliter la démonstration.
          """)]
